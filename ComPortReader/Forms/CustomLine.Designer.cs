namespace ComPortReader.Forms
{
    partial class CustomLine
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.info.Text = "Чтение данных завершено. Используя двойной щелчок левой кнопкой мыши выберите две" +
    " точки на графике которые соответсвуют его линейному участку. Затем нажмите потв" +
    "ердить.";
