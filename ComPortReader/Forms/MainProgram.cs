...
namespace ComPortReader
{
    public partial class MainProgram : Form
    {
        ...
        SerialDataReceivedEventHandler dataRecieved;
        double xMin = 0;
        ...
        {
            dataRecieved = new SerialDataReceivedEventHandler(port_DataReceived);
            port.DataReceived += dataRecieved;
        }
        ...
        private void startBuilding_Click(object sender, EventArgs e)
        {
            ...
            if (port == null) MessageBox.Show("Порт не открыт");
